...
<body>
 ...
 <!-- Navigation -->
    ...
    <ul class="nav navbar-nav navbar-right">
       ...
       <center><h3>Welcome, Zain. What courses would you like to transfer?</h3>
                        ...
                        <tr id='addr0' data-id="0" class="hidden">
                            ...
                            <td data-name="courseName">
                                <select name="courseDropdown">
                                   ...
                                   $result = pg_query($dbconn, "SELECT courseTitle, courseId FROM InstitutionCourses");
