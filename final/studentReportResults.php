...
<body>
 ...
 <!-- Navigation -->
    ...
    <div class="container">
  <h2>All done!</h2>
  <p>Here is your transfer summary:</p>            
  <table class="table table-hover">
    ...
    <tbody>
      <tr>
        <td>Composition I</td>
        <td>College Writing 1</td>
        <td>3.0</td>
      </tr>
      <tr>
        <td>Social Problems in Today's World</td>
        <td class="bg-danger">None</td>
        <td>0.0</td>
      </tr>
      <tr>
        <td>Precalculus Mathematics</td>
        <td>Math before Calculus</td>
        <td>4.0</td>
      </tr>
    </tbody>
  </table>
...
<h4>When you are done reviewing your transfer summary above, you can logout.</h4></center>
